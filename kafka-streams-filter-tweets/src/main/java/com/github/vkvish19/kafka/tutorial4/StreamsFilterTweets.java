package com.github.vkvish19.kafka.tutorial4;
...
public class StreamsFilterTweets
{
    ...
    private static Logger logger = LoggerFactory.getLogger(StreamsFilterTweets.class.getSimpleName());
    ...
    public static void main(String[] args)
    {
        ...
        KStream<String, String> filteredStream = inputTopic.filter(
                ...
                (k, jsonTweet) -> extractUserFollowersInTweet(jsonTweet) > 10_000
        );
